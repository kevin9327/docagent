...
| **Hangul** | HWP 5 / HWPX / HWP 3 / HML as codecs, not as the product name. HWP 5 `CHAR_SHAPE`, HWPX `hh:charPr`, and HML `CHARSHAPE` keep bold / italic / underline / strike / super / sub on the same IR. |
