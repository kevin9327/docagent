...
| **Hangul** | HWP 5 / HWPX / HWP 3 / HML as codecs, not as the product name. HWP 5 `CHAR_SHAPE` and HWPX `hh:charPr` keep bold / italic / underline / strike / super / sub on the same IR. |
