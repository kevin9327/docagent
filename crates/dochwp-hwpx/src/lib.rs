...
pub fn write(doc: &Document) -> Result<Vec<u8>, Error> {
    let mut cursor = Cursor::new(Vec::new());
    {
        ...
        zip.write_all(
            br#"<?xml version="1.0" encoding="UTF-8"?><ha:HCFVersion xmlns:ha="http://www.hancom.co.kr/hwpml/2011/application" targetApplication="DocHWP" major="1" minor="0" micro="0"/>"#,
        )?;
